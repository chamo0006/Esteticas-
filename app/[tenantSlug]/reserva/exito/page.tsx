  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="bg-card rounded-3xl p-8 shadow-sm border border-border max-w-sm w-full text-center">
        ...
        <h1 className="font-serif text-2xl text-foreground mb-2">¡Pago confirmado!</h1>
        <p className="text-muted-foreground text-sm mb-6">
          Tu seña fue procesada correctamente. Recibirás un email con los detalles de tu turno.
        </p>
