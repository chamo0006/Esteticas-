...
function MockAdminUI() {
  return (
    <div className="relative w-full max-w-[480px] mx-auto select-none pointer-events-none">
      ...
      <div className="absolute -inset-8 bg-gradient-to-br from-violet-400/30 via-rose-300/20 to-transparent rounded-[3rem] blur-3xl animate-drift" />
      ...
      <div className="absolute -left-3 bottom-8 bg-white rounded-xl shadow-lg border border-violet-100/80 p-3 w-36 animate-float-alt">
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-md border-b border-border animate-hero">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <Link
              href="/registrar"
              className="px-4 py-2 bg-violet-600 hover:bg-violet-500 text-white text-sm font-medium rounded-xl transition-colors shadow-sm"
            >
              Empezar gratis
            </Link>
          </div>
      ...
      <section id="inicio" className="relative pt-16 pb-28 px-4 sm:px-6 overflow-hidden">
        {/* Animated blobs */}
        <div className="absolute top-0 right-0 w-[560px] h-[560px] bg-violet-100/60 rounded-full -translate-y-1/2 translate-x-1/3 blur-3xl pointer-events-none animate-drift" />
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-rose-100/50 rounded-full translate-y-1/2 -translate-x-1/3 blur-3xl pointer-events-none animate-drift [animation-delay:4s]" />

        <div className="relative max-w-6xl mx-auto grid lg:grid-cols-2 gap-14 lg:gap-10 items-center">
          {/* Copy */}
          <div className="text-center lg:text-left">
            {/* Badge */}
            <div className="animate-hero [animation-delay:0ms] inline-flex items-center gap-2 bg-violet-50 text-violet-700 rounded-full px-4 py-1.5 text-xs font-medium mb-7 border border-violet-200">
            ...
            <h1 className="animate-hero [animation-delay:80ms] font-serif text-5xl sm:text-6xl lg:text-[3.75rem] font-light leading-[1.1] text-foreground mb-6">
              ...
              <em className="not-italic font-semibold text-violet-600">siguiente nivel</em>{' '}
              con tu propia plataforma de{' '}
              <em className="italic font-light text-foreground/70">turnos</em>
            </h1>
            ...
            <div className="animate-hero [animation-delay:280ms] flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
              <Link
                href="/registrar"
                className="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-violet-600 hover:bg-violet-500 text-white font-medium rounded-xl transition-all shadow-lg shadow-violet-200 hover:shadow-violet-300 hover:-translate-y-0.5 active:translate-y-0"
              >
        ...
        <div className="max-w-6xl mx-auto">
          <AnimateIn className="text-center mb-16">
            ...
            <h2 className="font-serif text-4xl sm:text-5xl font-light text-foreground mb-4">
              ...
              <em className="italic font-light text-violet-600">necesita</em>
            </h2>
      ...
      <section id="como-funciona" className="py-24 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto">
          <AnimateIn className="text-center mb-16">
            ...
            <h2 className="font-serif text-4xl sm:text-5xl font-light text-foreground mb-4">
              Cómo <em className="italic font-light text-violet-600">funciona</em>
            </h2>
            <p className="text-muted-foreground text-lg max-w-xl mx-auto leading-relaxed">
            ...
            {steps.map(({ n, title, desc }, i) => (
              <AnimateIn key={n} delay={i * 140} direction="up" className="relative text-center flex flex-col items-center">
                <div className="relative mb-6">
                  <div className="w-20 h-20 rounded-full bg-violet-600 flex items-center justify-center text-white font-serif font-light text-3xl shadow-lg shadow-violet-200 relative z-10">
                    {n}
                  </div>
                  <div className="absolute inset-0 rounded-full bg-violet-300/25 scale-[1.4] blur-sm" />
                </div>
          ...
          <AnimateIn className="text-center mt-14" delay={200}>
            <Link
              href="/registrar"
              className="inline-flex items-center gap-2 px-8 py-4 bg-violet-600 hover:bg-violet-500 text-white font-medium rounded-xl transition-all shadow-lg shadow-violet-200 hover:-translate-y-0.5"
            >
      ...
      <section id="precios" className="py-24 px-4 sm:px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <AnimateIn className="text-center mb-16">
            ...
            <h2 className="font-serif text-4xl sm:text-5xl font-light text-foreground mb-4">
              Invertí en el{' '}
              <em className="italic font-light text-violet-600">crecimiento</em>{' '}
              de tu negocio
            </h2>
            <p className="text-muted-foreground text-lg max-w-xl mx-auto leading-relaxed">
                ...
                >
                  {plan.popular && (
                    <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                      <span className="inline-flex items-center gap-1.5 bg-violet-600 text-white text-xs font-medium px-3.5 py-1.5 rounded-full shadow-md">
                  ...
                  <div className="mb-6">
                    <p className={`text-xs font-medium uppercase tracking-widest mb-1 ${plan.popular ? 'text-zinc-400' : 'text-muted-foreground'}`}>
                      {plan.tagline}
                    </p>
                  ...
                  <Link
                    ...
                    className={`block w-full text-center py-3 rounded-xl font-medium text-sm transition-all ${
                      plan.popular
                        ? 'bg-violet-600 hover:bg-violet-500 text-white shadow-md hover:-translate-y-0.5'
      ...
      <section id="contacto" className="py-24 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto">
          <AnimateIn className="text-center mb-16">
            ...
            <h2 className="font-serif text-4xl sm:text-5xl font-light text-foreground mb-4">
              <em className="italic font-light text-violet-600">Hablemos</em>
            </h2>
            <p className="text-muted-foreground text-lg max-w-xl mx-auto leading-relaxed">
      ...
      {/* ── FOOTER ─────────────────────────────────────────────────────────── */}
      <footer className="bg-zinc-900 text-zinc-400 py-8 px-4 sm:px-6">
